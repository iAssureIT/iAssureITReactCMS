...
>>>>>>> Stashed changes
  ...
  updtaeRepBlockInfo(event){
	...
	submitcmsBlockInfo(event){
		...
		axios
			.post('http://qaiassureitapi.iassureit.com/api/blocks/post',formValues)
  ...
  getBlockData(block_id){
    axios
      .get("http://qaiassureitapi.iassureit.com/api/blocks/get/"+block_id)
      .then((response)=>{
...
componentWillReceiveProps(nextProps){
  ...
  UpdateBlockInfo(event){
		...
		console.log("formValues=blocks>",formValues);
		axios
			.patch('http://qaiassureitapi.iassureit.com/api/blocks/patch/'+this.state.block_id,formValues)
		  	.then(function (response) {
		    // handle success
