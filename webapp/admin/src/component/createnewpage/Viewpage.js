...
class Viewpage extends React.Component {
	...
	getAllBlockList(){
		axios
				.get('http://qaiassureitapi.iassureit.com/api/blocks/get/list')
				.then((response)=>{
	...
	componentDidMount(){
			...
			axios
			.get('http://qaiassureitapi.iassureit.com/api/pages/get/page_block/'+urlParam)
	        .then((response)=>{
  ...
  //      console.log('urlParam=>',urlParam);
		...
		axios
			.patch('http://qaiassureitapi.iassureit.com/api/pages/patch/blocks/add/'+urlParam,AttachmentValues)
	...
	submitData(event){
		...
		axios
			.post('http://qaiassureitapi.iassureit.com/api/pages/patch/blocks/add/'+this.state.urlParam,AttachmentValues)
		  	.then(function (response) {
		    	console.log(response);
		  	})
		  	.catch(function (error) {
		...
		console.log("id delet", this.state.urlParam, deleteValues);
		 swal({
	        ...
	        .then((success) => {
	            ...
	            if (success) {
	            	axios
				    .patch('http://qaiassureitapi.iassureit.com/api/pages/patch/blocks/remove/'+this.state.urlParam,deleteValues)
				    .then((response)=>{
				     	// this.getListOfPages();
