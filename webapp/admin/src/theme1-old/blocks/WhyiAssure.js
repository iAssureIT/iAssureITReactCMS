					...
					<div className="col-lg-12 col-md-12 col-sm-12 col-xl-12 wBox1">
						...
						<div className="col-lg-6 col-md-6 col-sm-6 col-xl-6">
							<div className="infotext1 col-lg-10 col-md-10 col-sm-10 col-xl-10">
								...
								<h1 className="headingb1">Cost <b>Advantage</b>
								</h1>
...
{/*=========================== Mobile view ===========================================*/}
				<div className="WhyiAssureheight hidden-lg hidden-md">
					<div className="col-sm-12 col-xs-12 wBox1xs">
						...
						<div className="col-xs-12 col-sm-12 hidden-lg hidden-md">
							<div className="infotext1xs col-xs-12 col-sm-12 hidden-lg hidden-md">
								...
								<h1 className="headingb1xs">Cost <b>Advantage</b>
								</h1>
								<p className="para1xs col-sm-10 col-sm-offset-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
								Sed feu-giat euismod leo sed efficitur. Sed quis ultricies
								ante. Donec quistristique magna.

								</p>	
								<p className="para1xs col-sm-10 col-sm-offset-1">Etiam sit amet maximus dui. Phasellus iaculis consequat 
								tempus. Sed lorem nunc, tempor a vehicula et, molestie 
								sedmetus. Morbi feugiat nulla tincidunt nisl mattis sollicitudin.
								</p>
					...
					<div className="col-xs-12 col-sm-12 hidden-lg hidden-md wBox2xs">
						
						<div className="col-xs-12 col-sm-12 hidden-lg hidden-md">
							<div className="infotext1xs col-xs-12 col-sm-12 hidden-lg hidden-md pull-right">
							<div className="col-xs-12 col-sm-12 hidden-lg hidden-md">
									<ul className="dashBoxWiAxs col-xs-9 col-xs-offset-4 col-sm-6 col-sm-offset-5">
									  <li className="dash1WiAxs"></li>
									  <li className="dash2WiAxs"></li>
									  <li className="dash3WiAxs"></li>
									</ul>
								</div>
								<h1 className="headingb1xs">Modern<br/><b>Technologies</b>
								</h1>
								<p className="para1xs col-sm-10 col-sm-offset-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
								Sed feu-giat euismod leo sed efficitur. Sed quis ultricies
								ante. Donec quistristique magna.
						...
						<div className="col-xs-12 col-sm-6 col-sm-offset-3 hidden-lg hidden-md">
							<img className="infoImg1xs img-responsive" src="./images/30.png" alt="Bannerpng"/>

						</div>

					</div>
					<div className="col-xs-12 col-sm-12  wBox1xs">
						<div className="col-xs-12 col-sm-6 col-sm-offset-3 hidden-lg hidden-md">
							<img className="infoImg1xs img-responsive pull-right" src="./images/31.png" alt="Bannerpng"/>

						</div>
						<div className="col-xs-12 col-sm-12 hidden-lg hidden-md">
							<div className="infotext1xs col-xs-12 col-sm-12 hidden-lg hidden-md">
							<div className="col-xs-12 col-sm-12 hidden-lg hidden-md">
									<ul className="dashBoxWiA col-xs-9 col-xs-offset-4 col-sm-6 col-sm-offset-5">
									  <li className="dash1WiAxs"></li>
									  <li className="dash2WiAxs"></li>
									  <li className="dash3WiAxs"></li>
									</ul>
								</div>
								<h1 className="headingb1xs">Domain <b>Expertise</b>
								</h1>
								<p className="para1xs col-sm-10 col-sm-offset-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
								Sed feu-giat euismod leo sed efficitur. Sed quis ultricies
								ante. Donec quistristique magna.
					...
					<div className="col-xs-12 col-sm-12 hidden-lg hidden-md wBox2xs">
						...
						<div className="col-xs-12 col-sm-12 hidden-lg hidden-md">
							...
							<div className="infotext1xs col-xs-12 col-sm-12 hidden-lg hidden-md pull-right">
								...
								<h1 className="headingb1xs">High<br/> <b>Performance</b> Apps
								</h1>
								<p className="para1xs col-sm-10 col-sm-offset-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
								Sed feu-giat euismod leo sed efficitur. Sed quis ultricies
								ante. Donec quistristique magna.
						...
						<div className="col-xs-12 col-sm-6 col-sm-offset-3 hidden-lg hidden-md">
							<img className="infoImg1xs img-responsive" src="./images/32.png" alt="Bannerpng"/>
