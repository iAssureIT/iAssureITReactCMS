...
import "./staffaBanner.css";

export default class staffaBanner extends React.Component {
	...
	render() {
		return (
			<div className="banerheight container-fluid ">
				<div className="col-lg-12 col-md-12 hidden-sm hidden-xs container">
					...
					<div className="col-lg-6 col-md-6 col-lg-offset-1 col-md-offset-1 hidden-sm hidden-xs">
						<div className="pull-right mtop100sb">
							...
							<span className="h2Titlesb">STAFF
							</span><br/>
							<span className="h3Titlesb">AUGMENTATION
							</span>
						</div>	
					</div>
					<div className=" col-lg-5 col-md-5 hidden-sm hidden-xs row">
						<img className="bannerImgsb img-responsive" src="./images/8sa.png" alt="Bannerpng"/>
					</div>
				</div>
