		...
		return (
			<div className="ABOUTbanerheight container-fluid">
				<div className="col-lg-12 col-md-12 hidden-sm hidden-xs">
					<div className="col-lg-12 col-md-12 col-xs-12-12 col-sm-12 logoBox">
					...
					<div className="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						<div className="pull-right mtop305">
							...
							<span className="h2Title">ABOUT US
							</span><br/>
							<span className="h3Title">We are passionate about our work
							</span>
						</div>	
					</div>
				...
				<div className="col-xs-12 col-sm-12 hidden-lg hidden-md">
					...
					<div className="col-xs-12 col-sm-12 hidden-lg hidden-md row">
						<img className="abbannerImgxs img-responsive" src="./images/37.png" alt="Bannerpng"/>
					</div>
				</div>	
