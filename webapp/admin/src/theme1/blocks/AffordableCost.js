...
import './AffordableCost.css';
import axios from 'axios';

export default class AffordableCost extends Component{

    constructor(props) {
        super(props);
        this.state = {
          blocks: {
            "blockTitle": "<b>AFFORDABLE</b> COST",
    ...
    render(){
        return(
            <div className="afforablewrapper">
