...
import './DigitalMarkiting.css';
import axios from 'axios';

export default class DigitalMarkiting extends Component{

  constructor(props) {
    super(props);
    this.state = {
      blocks: {
        "blockTitle": "<b>DIGITAL</b> MARKETING",
