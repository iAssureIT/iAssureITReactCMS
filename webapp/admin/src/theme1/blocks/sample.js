...
export default class HomepageBanner extends React.Component {
    ...
    this.state = {
      blocks: {
        ...
        bgVideo: "/images/Invisalign_Life_Uninterrupted_English_In_Office_60_6_17_2020_6_22_14_PM.mp4",
        repeatedBlocks 		:[
        						{
						        	Title :"Would you like to see<br/> how your smile can<br/> transformed?"
						        },
						        {
						        	Title :"What is Lorem Ipsum Lorem Ipsum is simply dummy text of the printing typesetting industry"
						        },
						        {
						        	Title :"Easily generate Lorem Ipsum placeholder text in any number of characters."
						        }
						    ]
      },
      blockID:"",
									      ...
									      <div dangerouslySetInnerHTML={ { __html:result.Title}}></div>
									    			 <div className="col-lg-10 col-md-5 nopadding">
											      		...
											      		<div className="col-lg-6 col-md-6">
													      	<a href="/">
													      		<div className="h2cmpbtn ">Request Consult</div>
													      	</a>
												        </div>
