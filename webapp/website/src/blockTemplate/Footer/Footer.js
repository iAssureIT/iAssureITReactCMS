		...
		return (
			...
			<div className="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12 footerTop">
				<div className="col-lg-3 col-md-3 col-sm-3 col-xs-6 wrap1">
					<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 bgcolor">
				...
				<ul className="footer3">
						  <li className="clrwt clrwt000 addresstitle"><b>Address</b></li>
						    <li className="footertitle addresstitle"><i class="fas fa-map-marker-alt"></i> 323 Amanora Chambers Magarpatta Pune Maharastra 411028</li>
				...
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 bgcolor">
				<ul className="footer2">
							 <li className="clrwt clrwt00 clrrr"><b>Connect with us</b>
					...
					{/* <div className=" col-lg-3 col-md-3 col-sm-3 col-xs-6 ">
						 <ul className="footer2">
							 <li className="clrwt supportheading"><b>Services</b></li>
							   ...
							   <li className="footertitle supportheading">Web Apps</li>
							  <li className="footertitle supportheading">Mobile Apps</li>
							 19px  <li className="footertitle supportheading">Business Portails</li> 
							   <li className="footertitle supportheading">eCommerce Portails</li> 
							    <li className="footertitle supportheading">Staff Augumentation</li>  
						</ul>
					 </div> */}
